...
API_ID = int(os.environ.get("API_ID","4324480d46d2b4a14daa7c93755703f2"))
...
def run_flask():
    app.run(host="0.0.0.0", port=int(os.environ.get("PORT", 8080))) # Use here 8080 port,if you are deploying it on koyeb
